...
export default function MediaItem({ item }) {
    ...
    return <>
        ...
        <div className="col-md-2 cursor-pointer pb-3 ">
            <Link to={`/itemdetails/${item.id}/${item.media_type}`}>
                <div className="movie position-relative rounded-3 bg-light sh">
                    {item.poster_path ?
                    ...
                    <h3 className='h6 movie-title my-2 pb-3 text-center'>{item.title} {item.name}</h3>
